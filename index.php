...
<head>
    ...
    <title>E-Learning SD N Jatirawa 02</title>
...
?>
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./">
                    <img src="style/assets/img/home1.png" />
                </a>
                    ...
                    <ul class="nav">
                        ...
                        <li class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="false">
                                ...
                                <h6><center><b>Profil</b></center></h6>
                            </a>
                            <div class="dropdown-menu dropdown-settings">
                                ...
                                <hr />
                                <center><a href="?hal=detailprofil" class="btn btn-info btn-sm">Detail Profil</a> <a href="?hal=editprofil" class="btn btn-primary btn-sm">Edit Profil</a></center>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <center>&copy; 2020 | E-Learning  </center>
                </div>
