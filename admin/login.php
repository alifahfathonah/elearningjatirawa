...
<head>
	...
	<style type="text/css">
	body{background:  url(style/assets/img/lbg.png);}
	html,body{
	    position: relative;
	    height: 100%;
...
<div class="container">
	<div class="login-container">
        <div id="output"></div>
        <div class="avatar">
        	<img src="style/assets/img/avatar.png">
        </div>
        <div class="form-box">
            <input name="user" type="text" placeholder="username">
            <input name="pass" type="password" placeholder="password">
            <button class="btn btn-info btn-block login" type="submit">Login</button>
            <button class="btn btn-info btn-block continue" style="display:none;">Next</button>
        </div>
    </div>
</div>
    	...
    	$.ajax({
    		...
    		success : function(msg) {
        		if(msg == 'sukses') {
		            ...
		            $(".avatar").css({
		                "background-image": "url('style/assets/img/padlock.png')"
		            });
