    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    ?>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="?page=pengajar" class="<?php if(@$_GET['page'] == 'pengajar') { echo 'active-menu'; } ?>"> <span class="glyphicon glyphicon-envelope"></span> Manajemen Pengajar  </a>
                                </li>
                                <li>
                                    <a href="?page=siswa" class="<?php if(@$_GET['page'] == 'siswa') { echo 'active-menu'; } ?>"><span class="glyphicon glyphicon-envelope"></span> Manajemen Siswa</a>
                                </li>
                                <li>
                                    <a href="?page=siswaregistrasi" class="<?php if(@$_GET['page'] == 'siswaregistrasi') { echo 'active-menu'; } ?>"><span class="glyphicon glyphicon-envelope"></span> Registrasi Siswa</a>
                                </li>
                            </ul>
                        </li>
                    ...
                    ?>
                    <li>
                        <a class="<?php if(@$_GET['page'] == 'kelas') { echo 'active-menu'; } ?>" href="?page=kelas"><i class="fa fa-table"></i> Data Kelas</a>
                    </li>
                    <li>
                        <a class="<?php if(@$_GET['page'] == 'mapel') { echo 'active-menu'; } ?>" href="?page=mapel"><i class="fa fa-fw fa-file"></i> Mata Pelajaran</a>
                    </li>
                    <li>
                        <a class="<?php if(@$_GET['page'] == 'quiz') { echo 'active-menu'; } ?>" href="?page=quiz"><i class="fa fa-bar-chart-o"></i> Tugas / Quiz</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
				...
				<footer><p> <center>&copy; 2020 | E-learning Jatirawa<center></p></footer>
            </div>
        </div>
    </div>
</body>
