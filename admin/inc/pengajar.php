	        ...
	        <div class="panel panel-default">
	            ...
	            <div class="panel-body">
					<form method="post" action="?page=pengajar&action=prosestambah" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            <input type="email" name="email" class="form-control" placeholder="Ex. namapengguna@gmail.com" />
                        </div>
                        <div class="form-group">
                            <label>Alamat *</label>
                        ...
                        <div class="form-group">
                            <label>Jabatan *</label>
                            <input type="text" name="jabatan" class="form-control" placeholder="Ex. Guru SD" required />
                        </div>
						<div class="form-group">
                            <label>Foto</label>
	        ...
	        <div class="panel panel-default">
	            ...
	            <div class="panel-body">
					<form method="post" action="?page=pengajar&action=prosesedit&id=<?php echo $data['id_pengajar']; ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            <input type="email" name="email" value="<?php echo $data['email']; ?>" class="form-control" placeholder="Ex. namapengguna@gmail.com" />
                        </div>
                        <div class="form-group">
                            <label>Alamat *</label>
