...
<head>
    ...
    <title>Daftar E-Learning SD N Jatirawa 02</title>
...
<body>
    <header>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    Anda sudah punya akun ? Silahkan <a href="./" class="btn btn-xs btn-success">Login</a>
                </div>
            </div>
        </div>
    </header>
    ...
    <div class="content-wrapper">
        <div class="container">
            ...
            if(@$_GET['page'] == '') { ?>
                ...
                <b>SILAHKAN DAFTAR UNTUK MASUK KE E-LEARNING !</b>
            </marquee>
                </div>
                <div class="row">
                    <div class="col-md-12">
